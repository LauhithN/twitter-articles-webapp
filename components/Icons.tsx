// Shared SVG icons - Server Component (no 'use client' needed)
...
export function HeartFilledIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
...
export function RetweetIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
